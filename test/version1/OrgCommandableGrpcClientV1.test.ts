...
import { OrgRolesCommandableGrpcServiceV1 } from 'service-orgroles-node';
import { OrgRolesCommandableGrpcClientV1 } from '../../src/version1/OrgRolesCommandableGrpcClientV1';
...
suite('OrgRolesCommandableGrpcClientV1', ()=> {
    let service: OrgRolesCommandableGrpcServiceV1;
    let client: OrgRolesCommandableGrpcClientV1;
    ...
    suiteSetup(async () => {
        ...
        let references: References = References.fromTuples(
            ...
            new Descriptor('service-orgroles', 'service', 'commandable-grpc', 'default', '1.0'), service
        );
        controller.setReferences(references);
        service.setReferences(references);

        client = new OrgRolesCommandableGrpcClientV1();
