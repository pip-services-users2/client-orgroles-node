...
import { OrgRolesGrpcServiceV1 } from 'service-orgroles-node';
import { OrgRolesGrpcClientV1 } from '../../src/version1/OrgRolesGrpcClientV1';
...
suite('OrgRolesGrpcClientV1', ()=> {
    let service: OrgRolesGrpcServiceV1;
    let client: OrgRolesGrpcClientV1;
    ...
    suiteSetup(async () => {
        ...
        client = new OrgRolesGrpcClientV1();
